	...
	<div class="blogitems">
		<div class="blog-content">
			 <?php if (  (function_exists('has_post_thumbnail')) && (has_post_thumbnail())  ) { ?>  
				<div class="blog-img">
					<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('daisy-post-image'); ?></a>
				</div>
			 <?php } ?>
			 <div class="blog-top">
				<a href="<?php the_permalink(); ?>"><h3><?php the_title(); ?></h3></a>
				<ul class="blog-socials">
					<li><a href="<?php the_permalink(); ?>"><i class="fa fa-calendar-o"></i><span><?php echo esc_html(get_the_date()); ?></span></a></li>
					<?php if ( has_tag() ) { ?>
