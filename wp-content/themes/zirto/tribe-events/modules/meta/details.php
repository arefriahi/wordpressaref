 ...
 * @var int Event post id
 */
$time_title = apply_filters( 'tribe_events_single_event_time_title', esc_html__( 'Time:', 'zirto' ), $event_id );
	...
	<dl>
		...
		if ( tribe_event_is_all_day() && tribe_event_is_multiday() ) :
			...
			<ul class="venue details">
				<li>
					<dt> <?php esc_html_e( 'Start:', 'zirto' ) ?> </dt>
					<dd>
				...
				<li>
					<dt> <?php esc_html_e( 'End:', 'zirto' ) ?> </dt>
					<dd>
		...
		elseif ( tribe_event_is_all_day() ):
			...
			<dt> <?php esc_html_e( 'Date:', 'zirto' ) ?> </dt>
			<dd>
				<abbr class="tribe-events-abbr tribe-events-start-datetime published dtstart" title="<?php echo esc_attr( $start_ts ) ?>"> <?php echo esc_html( $start_date ) ?> </abbr>
			</dd>
		...
		if ( ! empty( $cost ) ) : ?>
			...
			<dt> <?php esc_html_e( 'Cost:', 'zirto' ) ?> </dt>
		...
		<?php echo tribe_meta_event_tags( sprintf( esc_html__( '%s Tags:', 'zirto' ), tribe_get_event_label_singular() ), ', ', false ) ?>
